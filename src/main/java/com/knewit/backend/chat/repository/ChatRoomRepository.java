...
public interface ChatRoomRepository extends JpaRepository<ChatConversation, Long> {
    ...
    List<ChatConversation> findRoomsByUserId(@Param("userId") Long userId);
    ...
    Optional<ChatConversation> findDirectRoom(@Param("user1") Long user1, @Param("user2") Long user2);
}