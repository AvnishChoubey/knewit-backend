...
public class AuthController {
    ...
    public ResponseEntity<ProfileCompletionResponse> completeProfile(@AuthenticationPrincipal CustomUserDetails customUserDetails,
                                                                     @ModelAttribute ProfileCompletionRequest profileCompletionRequest) {
        return ResponseEntity.ok(authService.completeProfile(customUserDetails, profileCompletionRequest));
    }
}
